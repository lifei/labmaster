...
<g:link controller="work" action="create" params="['plan.id':
planInstance?.id]">★${message(code: 'default.add.label', args: [message(code: 'work.label', default: 'Work')])}</g:link>
                                <ul>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatDate date="${planInstance?.deadline}" /></td>
