...
<html>
    <head>
        ...
        <sfu:generateConfiguration fileSize="30" form="bibtex" buttonImageFile="browse-button-sprite.png" buttonWidth="104" buttonHeight="30"/>
    </head>
    <body>
        <div class="nav">
...
<tr class="prop">
    <td valign="top" class="name">
      <label for="abstruct">
          <g:message code="paper.abstruct.label" default="Abstruct" />
          (<g:message code="paper.abstruct.help.label" default="Abstruct" />)
      </label>
    </td>
    <td valign="top" class="value ${
        hasErrors(bean: paperInstance, field: 'abstruct', 'errors')}">
...
<tr class="prop">
    <td valign="top" class="name">
      <label for="author">
          <g:message code="paper.author.label" default="Author" />
      </label>
    </td>
    <td valign="top" class="value ${
        hasErrors(bean: paperInstance, field: 'author', 'errors')}">
...
<tr class="prop">
    <td valign="top" class="name">
        <label for="accessionNumber">
            <g:message code="paper.accessionNumber.label" default="Accession Number" />
        </label>
    </td>
    <td valign="top" class="value ${
        hasErrors(bean: paperInstance, field: 'accessionNumber', 'errors')}">
        <g:textField name="accessionNumber" value="${paperInstance?.accessionNumber}" />
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="addinfopost" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
