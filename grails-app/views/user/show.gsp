            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.realName.label" default="Real Name" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.groups.label" default="Groups" /></td>
