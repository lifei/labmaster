                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="member" action="show" id="${testInstance?.user?.id}">${testInstance?.user?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="testType" action="show" id="${testInstance?.type?.id}">${testInstance?.type?.encodeAsHTML()}</g:link></td>
